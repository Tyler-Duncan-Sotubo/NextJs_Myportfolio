...
export const Nav = () => {
  ...
  return (
    <>
      <nav
        className={`flex justify-between items-center bg-skin-background  md:px-32 px-6 py-8 md:text-sm text-skin-primary font-Inter relative top-0  
         `}>
        <a href="/">
          <p
        ...
        <div className="flex md:gap-10 gap-6 items-center">
          ...
          <div
            ...
            <div
              className={`after:content-[''] after:block w-6 h-[2px] bg-skin-accent mb-2 duration-700 relative ${
                isOpen ? "rotate-[-45deg] top-[8px]" : "top-0"
              } ${color && " bg-gray-200"}`}></div>
            <div
              className={`before:content-[''] before:block w-6 h-[2px] bg-skin-accent mt-2 duration-700 relative ${
